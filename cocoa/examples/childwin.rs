...
use cocoa::{appkit::NSWindowOrderingMode, base::{selector, id, nil, NO}};
...
fn main() {
    unsafe {
        ...
        // add_child_to(_win_srgb_red, _win_black);
        add_child_to(_win_black, _win_srgb_red);
...
unsafe fn add_child_to(child_win: id, parent_win: id) -> id {
    parent_win.addChildWindow_(child_win, NSWindowOrderingMode::NSWindowAbove);
